...
#         moves = ['MM', 'M', 'MC', 'CC', 'C']
#         possible_actions = []
#         missionaries, cannibals, leftBank = state

#         if leftBank == False:
#             missionaries = 3 - missionaries
#             cannibals = 3 - cannibals
#         # 2 missionaries cross to the right bank
#         if self.checkState(missionaries-2, cannibals):
#             possible_actions.append(moves[0])
#         # 1 missionary, 1 cannibal
#         if self.checkState(missionaries-1, cannibals-1):
#             possible_actions.append(moves[2])
#         # 1 cannibal
#         if self.checkState(missionaries, cannibals-1):
#             possible_actions.append(moves[4])
#         # 1 missionary
#         if self.checkState(missionaries-1, cannibals):
#             possible_actions.append(moves[1])
#         # 2 cannibals
#         if self.checkState(missionaries, cannibals-2):
#             possible_actions.append(moves[3])
#         return possible_actions

#         # if self.checkState(state):
#         #     missionaries, cannibals, leftBank = state
#         #     #If on the right bank
#         #     if leftBank == False:
#         #         missionaries = 3 - missionaries
#         #         cannibals = 3 - cannibals

#         #     if missionaries == cannibals and missionaries != 1:
#         #         possible_actions.remove('MM')
#         #         possible_actions.remove('M')
#         #     elif missionaries == cannibals and missionaries == 1:
#         #         possible_actions.remove('MM')
#         #         possible_actions.remove('CC')
#         #     elif missionaries > cannibals and cannibals == 2:
#         #         possible_actions.remove('MM')
#         #     elif missionaries > cannibals and cannibals == 1:
#         #         possible_actions.remove('M')
#         #         possible_actions.remove('CC')
#         #     elif missionaries > cannibals and cannibals == 0:
...
#         action = delta[action]
#         if leftBank == True:
#             new_state[0] = new_state[0] + action[0]
#             new_state[1] = new_state[1] + action[1]
#         else:
#             new_state[0] = new_state[0] - action[0]
#             new_state[1] = new_state[1] - action[1]
